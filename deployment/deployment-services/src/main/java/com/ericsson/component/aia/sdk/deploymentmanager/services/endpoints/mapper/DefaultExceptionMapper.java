 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.component.aia.sdk.deploymentmanager.services.endpoints.mapper;
...
import com.ericsson.component.aia.sdk.deploymentmanager.services.endpoints.response.ServiceResponse;
import com.ericsson.component.aia.sdk.deploymentmanager.services.endpoints.response.ServiceResponse.ResponseError;
...
public class DefaultExceptionMapper {
    ...
    private ServiceResponse<Object> getResponseError(final Exception exception) {
        ...
        serviceResponse.getError().setMessage(exception.getMessage());
